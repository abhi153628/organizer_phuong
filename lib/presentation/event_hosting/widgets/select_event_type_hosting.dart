...
class SelectinngEventType extends StatefulWidget {
  final Function(int?) onSelectionChanged;

  const SelectinngEventType({Key? key, required this.onSelectionChanged}) : super(key: key);

  @override
  _SelectinngEventTypeState createState() => _SelectinngEventTypeState();
}

class _SelectinngEventTypeState extends State<SelectinngEventType> {
  int? selectedIndex;
