...
int ?initialSelection;
  ...
  @override
  _EditSelectedEventTypeState createState() => _EditSelectedEventTypeState();
}


class _EditSelectedEventTypeState extends State<EditSelectedEventType> {
  @override
void initState() {
  super.initState();
  // Set the initial selected index if provided
  selectedIndex = widget.initialSelectedIndex ?? widget.initialSelection;
}
  int? selectedIndex;
  ...
  Widget build(BuildContext context) {
    ...
    final double scaleFactor =
        screenSize.width / 375; // Using 375 as base width
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color:
                        Colors.black.withOpacity(0.1 * _scaleAnimation.value),
                    blurRadius: 10 * _scaleAnimation.value * widget.scaleFactor,
                    spreadRadius:
                        2 * _scaleAnimation.value * widget.scaleFactor,
                  ),
                ],
              ),
              child: Stack(
